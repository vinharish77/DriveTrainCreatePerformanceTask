...
public class AutoDriveToDistance extends Command {
    ...
    double distance;
    double speed;
	public AutoDriveToDistance(double distance, double speed) {
    ...
    protected void initialize() {
    	...
    	PIDRobotDrive.setPIDType(PIDType.driveToDistanceTwoEncoder);
    	drivePID = new PIDController(KP,KI,KD,RobotMap.rearRight, RobotMap.talonDriveBase);
